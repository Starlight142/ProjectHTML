<%@ Page Title="Add Wearable" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddWearable.aspx.cs" Inherits="Pages_AddWearable" %>
    <%-- Page for administrators to add new wearable products. --%>
        ...
        <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table style="width:100%;" class="wearableTable">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="listType" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                            DataSourceID="sdsType" DataTextField="type" DataValueField="type">
                        ...
                        <asp:SqlDataSource ID="sdsType" runat="server"
                            ...
                            SelectCommand="SELECT [type] FROM [typeWearable]"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddImage" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                            Width="300px">
                            <asp:ListItem>-กรุณาเลือก-</asp:ListItem>
                        </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtReview" runat="server" TextMode="MultiLine" Width="332px" Height="98px">
                        </asp:TextBox>
                        <br />
                    </td>
                </tr>

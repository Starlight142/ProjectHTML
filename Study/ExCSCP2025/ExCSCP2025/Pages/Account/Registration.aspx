<%@ Page Title="Registration" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Registration.aspx.cs" Inherits="Pages_Account_Registration" %>
    <%-- User registration page with Ajax username availability check. --%>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtName" runat="server" AutoPostBack="True" Width="268px"
                ...
                <tr>
                    ...
                    <td style="height: 26px">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                            ...
                            ValidationExpression="[\w-]+@[\w-]+\.(com|net|org|co\.th|or\.th|ac\.th|go\.th)">

<%@ Page Title="Login" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Login.aspx.cs" Inherits="Pages_Account_Login" %>
    <%-- User login page. --%>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                            ControlToValidate="txtLogin" ErrorMessage="*" ForeColor="#FF3300">
                ...
                <tr>
                    <td style="width: 228px; text-align: right">
                        ...
                        <br />
                        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Pages/Account/Registration.aspx">

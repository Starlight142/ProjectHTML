            ...
            <div class="d-flex justify-content-between align-items-center mb-5 fade-in-up">
                <div class="text-start">
                    ...
                    <p class="lead text-muted" style="max-width: 600px;">
                        ติดตามข่าวสาร กิจกรรม และเคล็ดลับการดูแลสุขภาพด้วยกลิ่นบำบัด
                    </p>
                </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <article class="news-card">
                                <img src="<%= string.IsNullOrEmpty(item.ImageUrl) ? "
                                    https://via.placeholder.com/800x600?text=Softscent" : item.ImageUrl %>" alt="<%=
                                    item.Title %>" class="news-img" />
                                    <div class="content-box">
                                        ...
                                        <a href="#" class="read-more-btn">อ่านต่อ <i class="fas fa-arrow-right"></i></a>
                                    </div>
                            </article>
                        </div>
                        <% } %>
